...
const validateAndUpdatePaymentService = async (gatewayData) => {
    console.log("GateWay : ", gatewayData);
    ...
    if(status === "VALID" || status === "VALIDATED"){
        ...
        console.log("Validation Response : ", validateionResponse.status);
 ...
 * Handle fail/cancel
 */
const updatePaymentStatusService = async (tranId, newStatus) => {
     return prisma.paymentLog.update({
        where: { tranId },
...
export const paymentService = {
    ...
    validateAndUpdatePaymentService,
